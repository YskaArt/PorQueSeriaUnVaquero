...
public class AdsManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Muestra un rewarded ad. Usa el preloaded si existe; si no, intentar� cargar y mostrar.
    /// Llama onComplete(true) si el usuario obtuvo reward, false si fall�/no reward.
    /// </summary>
